...
- I want the user to have a positive response to the site and spend longer on it as this will motivate return visits.
    - Users will be able to view the community page which will produce a positive response and lead them to stay on the site longer.
     They will be made aware that they must create an account to access all actions on the page.
